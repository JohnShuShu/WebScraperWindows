...
public class MedHelpScraper extends Thread {
    ...
    public static String dateString =  "Anxeity " + new SimpleDateFormat("yyyy-MM-dd HH-mm-ss").format(new Date());
...
//                    System.out.println(Url);
                    ...
                    if(Url.contains("<span class=\"post_date\">")){
                        ...
                        Pattern threadDatePattern1 = Pattern.compile("<span class=\"post_date mh_timestamp\" data-timestamp=\".+?\">(.+?)<\\/span>");
...
//                System.out.println(thread.appLink);
                ...
                System.out.print(numberOfComments);
