...
public class DataCleaner {
    ...
    public static void main(String[] args) {
        ...
        //            switch (choice){
        //                case 1:
        cleanThreads("/Users/johnshu/Desktop/WebScraper/HypotheticalCalculation.csv");
        //                    break;
        //
        //                case 2:
...
//                OrigThreads.add(currentIndex,currentThread);
    ...
    public static void cleanThreads(String file){
        ...
        // Writing out data to file
        File newfile = new File("/Users/johnshu/Desktop/WebScraper/CLEANED/FIXED_HypotheticalCalculation" + dateString + ".csv");
